 ...
 */
public class NotificationGenerator1 {
    ...
    public static void openActivtyNotification(Context context){
        ...
        nc.setContentText("Click Please To Go back To the App");
        nc.setContentText("It's Heads");
        nc.setVibrate(new long[] { 1000, 1000, 1000, 1000, 1000 });
